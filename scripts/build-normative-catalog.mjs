...
const ivaRules = [
  { id: "IVA-14-23-ART19-GERAL", article: "19.º", type: "TAX_RATE", regime: "GERAL", rate: 0.14, status: "CONFIRMED", evidence: "Conferência visual literal do artigo 19.º — alínea a)", source: "Lei n.º 14/23", rateTiers: [{ regime: "GERAL", rate: 0.14, scope: "importações, transmissões de bens e prestações de serviços" }, { regime: "SIMPLIFICADO", rate: 0.07, scope: "regime simplificado" }, { regime: "HOTELARIA_RESTAURACAO", rate: 0.07, scope: "prestações de serviços de hotelaria e restauração" }, { regime: "BENS_ALIMENTARES_INSUMOS_AGRICOLAS", rate: 0.05, scope: "importações e transmissões de bens alimentares de amplo consumo e insumos agrícolas constantes dos Anexos I e II" }, { regime: "CABINDA_ESPECIAL", rate: 0.01, scope: "importações e transmissões de bens sujeitas ao regime tributário especial aplicável à Província de Cabinda, com a excepção prevista na alínea e)" }], conditions: ["A taxa de 7% da alínea c) depende do cumprimento cumulativo das obrigações do n.º 2.", "Nos adiantamentos em que o bem a adquirir não esteja determinado aplica-se a taxa geral.", "A taxa aplicável é a vigente no momento em que o imposto se torna exigível."] },
  { id: "IVA-14-23-ART19-REDUZIDA", article: "19.º", type: "TAX_RATE", regime: "SIMPLIFICADO", rate: 0.07, status: "CONFIRMED", evidence: "Conferência visual literal do artigo 19.º — alínea b)", source: "Lei n.º 14/23", evidenceExcerpt: article19.slice(0, 1600) },
