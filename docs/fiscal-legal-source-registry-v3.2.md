...
### Notas visuais imediatas — DLP n.º 3/14 fornecido pelo utilizador

A revisão visual das primeiras cinco páginas do PDF `dlp-3-14.pdf` confirmou que o ficheiro reproduz o **Diário da República, I Série n.º 191, de 21 de Outubro de 2014**. A página 1 apresenta o sumário com o **Decreto Legislativo Presidencial n.º 3/14**, identificado como diploma que aprova a revisão e republicação do **Código do Imposto de Selo**. A página 2 confirma o preâmbulo do diploma, o artigo 1.º de aprovação, o artigo 3.º de revogação do Decreto Legislativo Presidencial n.º 6/11 e o artigo 5.º de entrada em vigor na data da publicação.

As páginas 3 a 5 mostram o início do Código republicado, com incidência objectiva e subjectiva, encargo do imposto, territorialidade, constituição da obrigação tributária e início do capítulo de isenções. A evidência visual é materialmente coerente com o OCR já preservado e confirma que o PDF contém mais do que mera referência catalográfica. A classificação de autenticidade institucional, contudo, continua dependente da proveniência do ficheiro, que permanece associada a cópia hospedada em Lex/Jurisnet.


### Notas visuais imediatas — Lei n.º 19/14 fornecida pelo utilizador

A revisão visual das primeiras cinco páginas do PDF `lei-19-14.pdf` confirmou que o ficheiro reproduz o **Diário da República, I Série n.º 192, de 22 de Outubro de 2014**. A página 1 apresenta o sumário com a **Lei n.º 19/14**, identificada como diploma que aprova o **Código do Imposto Industrial**. A página 2 confirma o articulado inicial da lei de aprovação, incluindo o regime transitório do artigo 4.º, a revogação no artigo 5.º e a estrutura de entrada em vigor no artigo 7.º, complementada visualmente pela página 3.

As páginas 3 a 5 mostram o início do Código do Imposto Industrial, com incidência, lucros realizados em Angola, lucros mundiais, sede fora de Angola, sujeitos passivos, isenções, grupos A e B, cadastro, determinação da matéria colectável, proveitos e ganhos e custos ou gastos. A evidência visual confirma que o PDF contém o corpo normativo do CII e não apenas uma referência sumária. A classificação de autenticidade institucional continua, contudo, condicionada pela proveniência `HOSTED_COPY_LEX/JURISNET`, apesar da coerência material do conteúdo.


### Notas visuais imediatas — Lei n.º 20/20 fornecida pelo utilizador

A revisão visual das primeiras cinco páginas do PDF `lei-20-20.pdf` confirmou que o ficheiro reproduz o **Diário da República, I Série n.º 101, de 9 de Julho de 2020**. A página 1 apresenta o sumário com a **Lei n.º 20/20**, identificada como diploma que aprova o **Código do Imposto Predial**. A página 2 confirma os artigos 1.º a 8.º da lei de aprovação, incluindo a revogação do Diploma Legislativo n.º 4044, da Lei n.º 18/11 e da Lei n.º 16/11, bem como a entrada em vigor 30 dias após a publicação.

As páginas 3 a 5 mostram o início do Código do Imposto Predial, com definições, âmbito, incidência, isenções, incidência subjectiva, matéria colectável de prédios urbanos e rústicos, renda do imóvel, tributação sobre transmissões gratuitas ou onerosas e declaração do rendimento colectável. A evidência visual confirma que o PDF contém o corpo normativo material do CIP. A proveniência do ficheiro continua, contudo, a ser uma cópia hospedada em Lex/Jurisnet, pelo que a activação normativa permanece dependente dos critérios de autenticidade e governação definidos no corpus V3.2.


### Notas visuais imediatas — Lei n.º 28/20 fornecida pelo utilizador

A revisão visual das primeiras cinco páginas do PDF `lei-28-20.pdf` confirmou que o ficheiro reproduz o **Diário da República, I Série n.º 109, de 22 de Julho de 2020**. A página 1 apresenta o sumário com a **Lei n.º 28/20**, identificada como diploma que altera o **Código do Imposto sobre os Rendimentos do Trabalho** e revoga a Lei n.º 9/19 e a Lei n.º 28/19. As páginas 1 a 2 confirmam o articulado alterador; as páginas 2 a 4 evidenciam a estrutura dos grupos A, B e C, o tratamento da não sujeição, a determinação da matéria colectável e o regime de liquidação.

A página 4 confirma visualmente o artigo 16.º com a regra segundo a qual a retenção na fonte nos Grupos B e C é aplicada à taxa de **6,5%**, enquanto a matéria colectável não sujeita a retenção na fonte nesses grupos é tributada à taxa de **25%**. A mesma página introduz a alteração da Tabela de Taxas do Código, e a página 5 mostra a tabela progressiva do Grupo A, bem como o artigo 6.º com entrada em vigor **30 dias após a publicação**. A evidência visual confirma conteúdo material suficiente para catalogação do diploma, mas a proveniência continua a ser `HOSTED_COPY_LEX/JURISNET`, pelo que a activação normativa permanece sujeita aos critérios de autenticidade e governação do corpus V3.2.


A revisão visual das páginas 21–25 da Lei n.º 28/20 confirmou a continuação integral da **Tabela dos Lucros Mínimos** e a sua extensão por sectores e verbas, bem como o fecho material do diploma. A página 25 mostra o termo da tabela e o fim da publicação da Lei n.º 28/20, seguido já por conteúdo não pertencente ao diploma seguinte do Diário, o que confirma que o PDF contém a peça normativa do IRT de forma materialmente completa no seu escopo.

Combinando as páginas iniciais e finais, a Lei n.º 28/20 passa a ter conteúdo visualmente confirmado quanto à alteração do CIRT, revogações, entrada em vigor, taxas dos Grupos B e C e tabela progressiva do Grupo A, com a mesma ressalva de proveniência: `HOSTED_COPY_LEX/JURISNET`. Esta confirmação documental melhora a cadeia do IRT, mas não elimina a necessidade de governação explícita antes de qualquer activação fiscal no ERP.


A revisão visual das páginas 7–11 do DLP n.º 3/14 confirmou a parte final do Código do Imposto de Selo, incluindo regras sobre responsabilidade tributária, anulação/compensação, obrigações dos sujeitos passivos, contabilidade e, sobretudo, o **Anexo A** com a tabela de actos, documentos, contratos, operações e títulos sujeitos ao imposto. As páginas 8 a 10 mostram verbas e taxas concretas para aquisições onerosas gratuitas, arrendamentos, actos societários, garantias, operações aduaneiras, publicidade, registos, seguros e outros actos tributáveis. A página 11 já inicia outro diploma do Diário, o que confirma que o PDF contém o fecho material do DLP n.º 3/14.

Combinando as páginas iniciais e finais, o DLP n.º 3/14 passa a ter conteúdo visualmente confirmado quanto à revisão e republicação do Código do Imposto de Selo, entrada em vigor, disposições de revogação e tabela anexa. Mantém-se, porém, a ressalva de proveniência `HOSTED_COPY_LEX/JURISNET`, pelo que a activação normativa do IS continua sujeita à governação do corpus V3.2 e não será promovida por inferência.


A revisão visual das páginas 15–19 da Lei n.º 19/14 confirmou o fecho material do **Código do Imposto Industrial**. As páginas 15–17 mostram a liquidação e cobrança, incluindo os artigos 66.º a 73.º; a página 17 confirma especificamente o **artigo 73.º (Taxa e pagamento)** na versão base, com taxa de **6,5%** sobre a matéria colectável no regime de tributação de serviços acidentais e retenção na fonte pelo contratante. As páginas 18–19 apresentam incumprimento de obrigações declarativas, inexactidões, período de tributação, língua oficial e exercício fiscal, e terminam já no diploma seguinte do Diário, o que confirma o fecho da Lei n.º 19/14.

Combinando as páginas iniciais e finais, a Lei n.º 19/14 passa a ter conteúdo visualmente confirmado quanto ao regime transitório, revogações, entrada em vigor, estrutura do CII e artigo 73.º de base. Esta confirmação melhora a cadeia documental do Imposto Industrial, mas não permite activar automaticamente a alteração da Lei n.º 27/22 nem o cálculo do II, porque continuam a faltar a consolidação integral com a Lei n.º 26/20, a regulamentação aplicável e a aprovação normativa explícita exigida pelo workflow do ERP.


A revisão visual das páginas 7–10 da Lei n.º 20/20 confirmou a parte material final do **Código do Imposto Predial**. As páginas 7 e 8 mostram o capítulo das taxas e da liquidação, incluindo a taxa de **0,5%** sobre a detenção aplicável aos prédios urbanos, a taxa de **0,6%** aplicável ao terreno para construção, a taxa de **25%** sobre prédios arrendados e a taxa de **2%** sobre transmissões de bens imóveis, bem como regras de liquidação na detenção, renda de prédios urbanos e rústicos, e transmissões gratuitas ou onerosas. As páginas 9 e 10 confirmam as obrigações das entidades públicas e privadas, tribunais, notários, conservatórias, entidades fornecedoras de água/energia/telecomunicações e serviços consulares, além do prazo de caducidade de 10 anos e do privilégio creditório.

A página 10 termina a Lei n.º 20/20 e já inicia a Lei n.º 21/20, o que confirma que o PDF fornecido contém a peça normativa do Imposto Predial materialmente completa no seu escopo. Combinando páginas iniciais e finais, a Lei n.º 20/20 passa a ter conteúdo visualmente confirmado quanto à aprovação do Código, revogações, entrada em vigor 30 dias após publicação, taxas-base e obrigações instrumentais. A proveniência continua, porém, marcada como `HOSTED_COPY_LEX/JURISNET`, pelo que a activação normativa do IP permanece sujeita aos critérios de autenticidade, cadeia e governação do corpus V3.2.
...
## 17. Política de fontes primárias submetidas pelo utilizador — 27-08-2026

Por instrução expressa do utilizador, os PDFs submetidos directamente ao projecto são tratados como **fontes primárias de trabalho** para o diploma exacto que identificam. Esta classificação aplica-se, nesta ronda, aos PDFs de Imposto Industrial, IRT, Imposto Predial e Imposto do Selo, preservando os respectivos hashes, páginas e referências documentais já registadas. A confirmação do utilizador é mantida no trilho de auditoria e não altera o texto, a vigência ou o âmbito de qualquer diploma.

A regra operacional passa a ser: utilizar os PDFs submetidos para fechar contas, movimentos, tabelas, modelos e regras dentro do seu escopo; só manter `REVIEW_REQUIRED` quando for encontrada **contradição concreta com lei/decreto angolano**, lacuna essencial no próprio documento, conflito temporal com alteração posterior ou impossibilidade técnica de validação. Não é exigido um diploma autónomo para cada regra contabilística geral quando a regra estiver documentalmente fundamentada e compatível com o PGCA.

O ficheiro `manualdecontabilidadeabibliaosnihoss.pdf`, identificado como manual brasileiro, fica **excluído do corpus fiscal e normativo angolano**. Não pode fornecer códigos de contas, taxas, regimes, modelos, obrigações ou regras fiscais do BALANCERTS.ERP. A Colectânea de Legislação da Contabilidade de Angola permanece fonte complementar de trabalho para regras contabilísticas e diplomas nela transcritos, sempre separada da classificação dos PDFs primários submetidos.
