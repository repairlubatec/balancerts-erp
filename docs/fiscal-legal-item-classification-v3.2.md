...
| Imposto Industrial | Lei n.º 19/14; Lei n.º 26/20; Lei n.º 27/22; DE n.º 83/19; DP n.º 194/20; reintegrações/amortizações; provisões; preços de transferência | Leis 19/14, 26/20 e 27/22: `A CONSOLIDAR`; DE 83/19 e DP 194/20: `A CONSOLIDAR`; matérias sem diploma nominal: `PDF OFICIAL A LOCALIZAR` | É necessária a cadeia do Código, alterações, modelos e anexos. Não activar taxas ou dedutibilidade por resumo. |
