...
| Imposto Industrial | Lei n.º 19/14; Lei n.º 26/20; Lei n.º 27/22; DE n.º 83/19; DP n.º 194/20; reintegrações/amortizações; provisões; preços de transferência | Lei 19/14 e Lei 27/22: `A CONSOLIDAR — conteúdo visualmente confirmado, proveniência hosted copy`; Lei 26/20, DE 83/19 e DP 194/20: `A CONSOLIDAR`; matérias sem diploma nominal: `PDF OFICIAL A LOCALIZAR` | O CII base e o artigo 73.º alterado foram conferidos nos PDFs fornecidos; falta fechar a cadeia posterior, modelos, anexos, vigência corrente e aprovação. Não activar taxa ou dedutibilidade. |
| IRT | Lei n.º 18/14; Lei n.º 28/20; DP n.º 194/20 quando aplicável; tabelas e modelos AGT | Lei 28/20: `A CONSOLIDAR — conteúdo visualmente confirmado, proveniência hosted copy`; Lei 18/14, tabelas/modelos: `PDF OFICIAL A LOCALIZAR` ou `A CONSOLIDAR` conforme fonte | A Lei 28/20 foi conferida nas alterações, grupos, taxas e tabelas; faltam cadeia posterior, modelos, vigência corrente e aprovação. |
...
| Imposto Predial | Lei n.º 20/20; DP n.º 191/21; alterações/modelos posteriores | Lei 20/20: `A CONSOLIDAR — conteúdo visualmente confirmado, proveniência hosted copy`; DP 191/21 e posteriores: `A CONSOLIDAR` | A Lei 20/20 foi conferida quanto ao Código, taxas-base, liquidação e obrigações; falta fechar regulamentação, cadastro, alterações, modelos, vigência corrente e aprovação. |
...
| Imposto do Selo | DLP n.º 3/14; tabela anexa; alterações; modelos/procedimentos; OGE 2026 | DLP 3/14 e tabela anexa: `A CONSOLIDAR — conteúdo visualmente confirmado, proveniência hosted copy`; alterações/modelos: `PDF OFICIAL A LOCALIZAR` | O Código e o Anexo A foram conferidos visualmente; alterações, modelos, vigência corrente e aprovação continuam pendentes. |
