...
export function DesktopTaskToolbar({ eyebrow, title, description, supportsRecordControls, onShortcuts, onNewRecord, onFilter, onSearch }: DesktopTaskToolbarProps) {
  return <div className="border border-[#aeb8c4] bg-white">
    <div className="flex flex-wrap items-center gap-1 border-b border-[#cbd3dc] bg-[#eef1f4] px-2 py-1.5">
      ...
      {supportsRecordControls && <Button type="button" size="sm" onClick={onNewRecord} className="ml-auto h-7 rounded-sm bg-[#1267d6] px-2 text-[11px] text-white hover:bg-[#0f58b8]"><Plus className="mr-1.5 h-3.5 w-3.5" /> Novo registo</Button>}
    </div>
