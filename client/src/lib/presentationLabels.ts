const labels: Record<string, string> = {
  ...
  OUTPUT: "Imposto liquidado",
  INPUT: "Imposto suportado",
  WITHHELD: "Imposto retido",
  IVA: "IVA",
  IRT: "IRT",
  IAC: "IAC",
  IEC: "IEC",
  IS: "Imposto de Selo",
  IP: "Imposto Predial",
  SISA: "Sucessões e Doações",
  IVM: "Impostos sobre Veículos Motorizados",
  ...
  FILE_ASSET_ARCHIVED: "Ficheiro arquivado",
  FILE_ASSET_VERSION_CREATED: "Versão do ficheiro criada",
  JOURNAL_ENTRY_POSTED: "Lançamento contabilístico publicado",
  JOURNAL_ENTRY_SUBMITTED: "Lançamento contabilístico submetido",
  JOURNAL_ENTRY_REVERSED: "Lançamento contabilístico estornado",
  JOURNAL_ENTRY_APPROVED: "Lançamento contabilístico aprovado",
  JOURNAL_ENTRY_REJECTED: "Lançamento contabilístico rejeitado",
  JOURNAL_ORPHAN_REFERENCES_REPAIRED: "Referências órfãs do lançamento corrigidas",
  DOCUMENT_NUMBER_RESERVED: "Documento Número Reservado",
  ...
  COMPANY_CONFIGURATION_UPDATED: "Configuração da empresa actualizada",
  "Journal orphan references repaired": "Referências órfãs do lançamento corrigidas",
  "Journal Entry Posted": "Lançamento contabilístico publicado",
