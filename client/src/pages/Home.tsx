...
export function getAccountTraceRoutes(selected: string) {
  const encoded = encodeURIComponent(selected);
  return { report: `/relatorios?focus=${encoded}`, document: `/documentos?focus=${encoded}`, audit: `/auditoria?focus=${encoded}` };
}
