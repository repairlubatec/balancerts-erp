export const angolaNormativeSources = [
  ...
  { code: "PGC-AO-82-01", title: "Decreto n.º 82/01 — PGC Angola", scope: "Referência contabilística do plano de contas", url: "https://cnnca.minfin.gov.ao/legislacao/sector-empresarial", verificationStatus: "PENDING" as const },
  { code: "LAW-14-23", title: "Lei n.º 14/23 — Alteração ao Código do IVA", scope: "Alterações ao Código do IVA, incidência, isenções, obrigações e demais regras fiscais", url: "https://angolex.com/paginas/codigos/alteracao-do-codigo-do-imposto-sobre-o-valor-acrescentado-14a-23a.html", verificationStatus: "PENDING" as const },
