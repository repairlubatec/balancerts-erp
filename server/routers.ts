...
export const appRouter = router({
  ...
  fiscal: router({
    ...
    validateFiscalInput: roleProcedure("fiscal", "validate")
      .input(
        z.object({
          netAmount: z.number(),
          regime: z.enum(["GERAL", "SIMPLIFICADO", "EXCLUSAO"]),
      ...
      .query(({ input }) => validateFiscalInput(input)),
  ...
  pgc: router({
    ...
    normativeLayers: roleProcedure("accounting", "read")
      ...
      .input(
        z
          .object({
            ...
            taxType: z.enum(["NONE", "IVA", "IRT"]).optional(),
            calculationBase: z.enum(["NONE", "NET", "GROSS", "WITHHOLDING_BASE", "FIXED"]).optional(),
