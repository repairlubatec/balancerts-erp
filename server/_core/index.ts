...
import { apiRateLimit, getRuntimeMetrics, securityHeaders } from "./security";
...
async function startServer() {
  ...
  app.get("/healthz", (_req, res) => res.status(200).json({ status: "ok", service: "balancerts-erp", metrics: getRuntimeMetrics() }));
