export const pendingMutationPolicy = [
  ...
  { mutation: "purchases.receive", allowsPending: false, guard: "owner+companyReady+period" },
  { mutation: "purchases.convertToSupplierDraft", allowsPending: false, guard: "owner+companyReady+receipt" },
